...
public class LoopService extends Service {
    ...
    public static void startLoopService(Context context) {
        ...
        System.out.println("开启轮询服务，轮询间隔：" + MLOOP_INTERVAL_SECS + "s");
...
////                System.out.println("长连接已恢复连接，退出轮询服务...");
////                quitLoopService(context);
////            } else {
////                if (isServiceRuning) {
////                    return START_STICKY;
...
//        }
    ...
    public void onDestroy() {
        super.onDestroy();
        System.out.println("轮询服务退出，执行onDestory()方法，inServiceRuning赋值false");
        isServiceRuning = false;
        timer.cancel();
        timer = new Timer();
    }
